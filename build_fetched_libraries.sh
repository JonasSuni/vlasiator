...
if [[ $PLATFORM == "-pioneer" ]]; then
   PARALLEL=64
elif [[ $PLATFORM == "-hile_cpu" || $PLATFORM == "-hile_gpu" || $PLATFORM == "-lumi_2403" || $PLATFORM == "-lumi_2503" || $PLATFORM == "-carrington" || $PLATFORM == "-frankenstein_hopper2_cuda" ]]; then
   PARALLEL=128
else
...
elif [[ $PLATFORM == "-hile_cpu" || $PLATFORM == "-hile_gpu" || $PLATFORM == "-lumi_2403" || $PLATFORM == "-lumi_2503" ]]; then
...
elif [[ $PLATFORM == "-hile_cpu" || $PLATFORM == "-hile_gpu" || $PLATFORM == "-lumi_hipcc" || $PLATFORM == "-lumi_2403" || $PLATFORM == "-lumi_2503" ]]; then
...
# Build papi
if [[ $PLATFORM != "-pioneer" && $PLATFORM != "-appleM1" && $PLATFORM != "-ukkogpu" && $PLATFORM != "-hile_cpu" && $PLATFORM != "-hile_gpu" && $PLATFORM != "-lumi_hipcc" && $PLATFORM != "-lumi_2403" && $PLATFORM != "-mahti_gcc_build" && $PLATFORM != "-mahti_cuda" && $PLATFORM != "-lumi_2503" && $PLATFORM != "-frankenstein_hopper2_cuda" ]]; then
...
if [[ $PLATFORM != "-leonardo_booster" && $PLATFORM != "-karolina_cuda" && $PLATFORM != "-ukkogpu" && $PLATFORM != "-hile_gpu" && $PLATFORM != "-lumi_hipcc" && $PLATFORM != "-mahti_cuda" && $PLATFORM != "-mahti_gcc_build" &&  $PLATFORM != "-frankenstein_hopper2_cuda" ]]; then
    ...
    elif [[ $PLATFORM == "-hile_cpu" || $PLATFORM == "-lumi_2403" || $PLATFORM == "-lumi_2503" ]]; then
