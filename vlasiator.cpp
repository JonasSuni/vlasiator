...
int simulate(int argn,char* args[]) {
   ...
   FsGrid< std::array<Real, fsgrids::edjdt::N_EDJDT>, FS_STENCIL_WIDTH> EDJdtGrid(fsGridDimensions, MPI_COMM_WORLD, periodicity,P::manualFsGridDecomposition);
   FsGrid< std::array<Real, fsgrids::edjdt::N_EDJDT>, FS_STENCIL_WIDTH> EDJdtDt2Grid(fsGridDimensions, MPI_COMM_WORLD, periodicity,P::manualFsGridDecomposition);
   ...
   perBGrid.DX = perBDt2Grid.DX = EGrid.DX = EDt2Grid.DX = EHallGrid.DX = EGradPeGrid.DX = EDJdtGrid.DX = EDJdtDt2Grid.DX = EGradPeDt2Grid.DX = momentsGrid.DX
   ...
   perBGrid.DY = perBDt2Grid.DY = EGrid.DY = EDt2Grid.DY = EHallGrid.DY = EGradPeGrid.DY = EDJdtGrid.DY = EDJdtDt2Grid.DY = EGradPeDt2Grid.DY = momentsGrid.DY
   ...
   perBGrid.DZ = perBDt2Grid.DZ = EGrid.DZ = EDt2Grid.DZ = EHallGrid.DZ = EGradPeGrid.DZ = EDJdtGrid.DZ = EDJdtDt2Grid.DZ = EGradPeDt2Grid.DZ = momentsGrid.DZ
   ...
   perBGrid.physicalGlobalStart = perBDt2Grid.physicalGlobalStart = EGrid.physicalGlobalStart = EDt2Grid.physicalGlobalStart
      = EHallGrid.physicalGlobalStart = EGradPeGrid.physicalGlobalStart = EDJdtGrid.physicalGlobalStart = EDJdtDt2Grid.physicalGlobalStart 
      = EGradPeDt2Grid.physicalGlobalStart = momentsGrid.physicalGlobalStart
