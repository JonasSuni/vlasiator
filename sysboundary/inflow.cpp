...
namespace SBC {
   ...
   void Inflow::fieldSolverBoundaryCondDJdtElectricField(
      FsGrid<std::array<Real, fsgrids::edjdt::N_EDJDT>, FS_STENCIL_WIDTH>& EDJdtGrid, cint i, cint j, cint k, cuint component) {
