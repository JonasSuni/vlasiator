...
std::string DataReductionOperatorCellParams::getName() const {
	return variableName;
}
...
std::string DataReductionOperatorFsGrid::getName() const {
	return variableName;
}
...
std::string DataReductionOperatorIonosphereElement::getName() const {
	return variableName;
}
...
std::string DataReductionOperatorIonosphereNode::getName() const {
	return variableName;
}
std::string DataReductionOperatorIonosphereNodeInt::getName() const {
	return variableName;
}
...
std::string DataReductionOperatorMPIGridCell::getName() const {
	return variableName;
}
...
std::string VariableBVol::getName() const {
	return "vg_b_vol";
}
...
std::string MPIrank::getName() const {
	return "vg_rank";
}
...
std::string BoundaryType::getName() const {
	return "vg_boundarytype";
}
...
std::string BoundaryLayer::getName() const {
	return "vg_boundarylayer";
}
...
std::string Blocks::getName() const {
	return popName + "/vg_blocks";
}
...
std::string VariablePressureSolver::getName() const {
	return "vg_pressure";
}
...
std::string VariablePTensorDiagonal::getName() const {
	return popName + "/vg_ptensor_diagonal";
}
...
std::string VariablePTensorOffDiagonal::getName() const {
	return popName + "/vg_ptensor_offdiagonal";
}
...
std::string VariableRhoNonthermal::getName() const {
	return popName + "/vg_rho_nonthermal";
}
...
std::string VariableRhoThermal::getName() const {
	return popName + "/vg_rho_thermal";
}
...
std::string VariableVNonthermal::getName() const {
	return popName + "/vg_v_nonthermal";
}
...
std::string VariableVThermal::getName() const {
	return popName + "/vg_v_thermal";
}
...
std::string VariablePTensorNonthermalDiagonal::getName() const {
	return popName + "/vg_ptensor_nonthermal_diagonal";
}
...
std::string VariablePTensorThermalDiagonal::getName() const {
	return popName + "/vg_ptensor_thermal_diagonal";
}
...
std::string VariablePTensorNonthermalOffDiagonal::getName() const {
...
std::string VariablePTensorThermalOffDiagonal::getName() const {
	return popName + "/vg_ptensor_thermal_offdiagonal";
}
...
std::string VariableEffectiveSparsityThreshold::getName() const {
	return popName + "/vg_effectivesparsitythreshold";
}
...
std::string VariablePrecipitationDiffFlux::getName() const {
	return popName + "/vg_precipitationdifferentialflux";
}
...
std::string VariableMuSpace::getName() const {
	return popName + "/vg_1dmuspace";
}
...
std::string VariablePrecipitationLineDiffFlux::getName() const {
...
std::string VariableEnergyDensity::getName() const {
	return popName + "/vg_energydensity";
}
...
std::string VariableHeatFluxVector::getName() const {
	return popName + "/vg_heatflux";
}
...
std::string VariableNonMaxwellianity::getName() const {
	return popName + "/vg_nonmaxwellianity";
}
