...
#include <stdlib.h>
#include <math.h>
#include "modifieddipole.hpp"
#include "../common.h"

//tilt_angle is agains the z axis in the x-z plane. In radians. Unused*/
void ModifiedDipole::initialize(const double moment,const double center_x, const double center_y, const double center_z, const double tilt_angle=0){
...
double ModifiedDipole::call( double x, double y, double z) const
{
   ...
   const double B=( 3*r[_fComponent]*rdotq-2*q[_fComponent]*r2)/r5;
